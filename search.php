...
<body>
    <div class="container">
        ...
        <div class="results">
            ...
            <li class="room"><?php echo $row['room_no']; ?>
                <a style="" onclick="bookThis(<?php echo ($row['room_no'].",'".$day."','".$time."'") ?>)">Book</a>
            </li>
            <?php } ?>
            </ul>
        </div>
        ...
        function bookThis(room_no,day,time){
            ...
            req.open('POST',"book_new.php?room_no="+room_no+"&day="+day+"&time="+time,true);
            req.send();
        }
